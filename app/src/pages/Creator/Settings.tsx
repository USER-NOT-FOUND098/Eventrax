...
export default function CreatorSettings() {
    ...
    const loadSettings = () => {
        try {
            const savedSettings = localStorage.getItem('creatorSettings');
            if (savedSettings) {
    ...
    const handleLogout = () => {
        localStorage.removeItem('creatorSettings');
        navigate('/login');
    };

    const handleDeleteData = () => {
        localStorage.removeItem('creatorSettings');
        localStorage.removeItem('creatorCache');
    ...
    const exportData = () => {
        ...
        a.href = url;
        a.download = `eventrax-creator-settings-${new Date().toISOString().split('T')[0]}.json`;
